...
class RdMeanSquaredError(tf.keras.metrics.Metric):

    def __init__(self, name='rd_mean_squared_error', **kwargs):
        super(RdMeanSquaredError, self).__init__(name=name, **kwargs)
    ...
    def update_state(self, y_true, y_pred, sample_weight):
        ...
        vals = K.mean(tf.math.square(vals), axis=-1)
