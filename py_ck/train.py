...
# inputs
train_ds = data.get_ci_train_data('../train/train_astral.txt', BUFFER_SIZE, BATCH_SIZE)
val_ds = data.get_ci_train_data('../train/val_astral.txt', BUFFER_SIZE, BATCH_SIZE)
...
m.save_weights('./checkpoints/ci1')
